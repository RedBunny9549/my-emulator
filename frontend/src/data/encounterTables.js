...
export const ENCOUNTER_TABLES = {
  emerald: {
    ...
    "mt pyre": ["Shuppet", "Duskull", "Wingull"],
    "cave of origin": ["Sableye", "Mawile", "Graveler", "Zubat"],
    ...
    "sky pillar": ["Claydol", "Golbat", "Sableye", "Mawile", "Altaria"],
  ...
  firered: {
    ...
    "power plant": ["Voltorb", "Magnemite", "Magneton", "Raichu", "Electabuzz", "Electrode"],
    "seafoam islands": ["Zubat", "Golbat", "Seel", "Dewgong", "Slowpoke", "Jynx"],
    "victory road": ["Geodude", "Graveler", "Onix", "Marowak", "Primeape", "Magneton", "Venomoth"],
    "cerulean cave": ["Kangaskhan", "Golbat", "Wobbuffet", "Kadabra", "Hypno", "Dodrio", "Ditto"],
  },
};
