  ...
  emerald: {
    gyms: [
      { num: 1, leader: "Roxanne", city: "Rustboro City", badge: "Stone Badge", team: [
        ...
        { name: "geodude", level: 12, ability: "Rock Head", moves: ["tackle", "defense-curl", "rock-throw", "rock-tomb"] },
        { name: "nosepass", level: 15, ability: "Sturdy", moves: ["tackle", "harden", "block", "rock-tomb"] }
      ]},
      { num: 2, leader: "Brawly", city: "Dewford Town", badge: "Knuckle Badge", team: [
        ...
        { name: "makuhita", level: 19, ability: "Thick Fat", moves: ["arm-thrust", "vital-throw", "reversal", "bulk-up"] }
      ]},
      { num: 3, leader: "Wattson", city: "Mauville City", badge: "Dynamo Badge", team: [
        ...
        { name: "manectric", level: 24, ability: "Static", moves: ["quick-attack", "howl", "shock-wave", "thunder-wave"] }
      ]},
      { num: 4, leader: "Flannery", city: "Lavaridge Town", badge: "Heat Badge", team: [
        ...
        { name: "torkoal", level: 29, ability: "White Smoke", moves: ["overheat", "body-slam", "flamethrower", "sunny-day"] }
      ]},
      { num: 5, leader: "Norman", city: "Petalburg City", badge: "Balance Badge", team: [
        ...
        { name: "slaking", level: 31, ability: "Truant", moves: ["yawn", "counter", "facade", "faint-attack"] }
      ]},
      { num: 6, leader: "Winona", city: "Fortree City", badge: "Feather Badge", team: [
        ...
        { name: "altaria", level: 33, ability: "Natural Cure", moves: ["dragon-breath", "dragon-dance", "earthquake", "aerial-ace"] }
      ]},
      { num: 7, leader: "Tate & Liza", city: "Mossdeep City", badge: "Mind Badge", team: [
        ...
        { name: "lunatone", level: 42, ability: "Levitate", moves: ["light-screen", "psychic", "hypnosis", "calm-mind"] },
        { name: "solrock", level: 42, ability: "Levitate", moves: ["sunny-day", "solar-beam", "psychic", "flamethrower"] }
      ]},
      { num: 8, leader: "Juan", city: "Sootopolis City", badge: "Rain Badge", team: [
        ...
        { name: "kingdra", level: 46, ability: "Swift Swim", moves: ["water-pulse", "double-team", "ice-beam", "rest"] }
      ]}
    ],
    elite: [
      { leader: "Sidney", title: "Elite Four", team: [
        ...
        { name: "absol", level: 49, ability: "Pressure", moves: ["aerial-ace", "rock-slide", "swords-dance", "slash"] }
      ]},
      { leader: "Phoebe", title: "Elite Four", team: [
        ...
        { name: "dusclops", level: 51, ability: "Pressure", moves: ["shadow-ball", "ice-beam", "rock-slide", "earthquake"] }
      ]},
      { leader: "Glacia", title: "Elite Four", team: [
        ...
        { name: "walrein", level: 53, ability: "Thick Fat", moves: ["surf", "body-slam", "ice-beam", "sheer-cold"] }
      ]},
      { leader: "Drake", title: "Elite Four", team: [
        ...
        { name: "salamence", level: 55, ability: "Intimidate", moves: ["dragon-claw", "crunch", "flamethrower", "rock-slide"] }
      ]},
    ],
    champion: { leader: "Wallace", title: "Champion", team: [
      ...
      { name: "milotic", level: 58, ability: "Marvel Scale", moves: ["recover", "surf", "ice-beam", "toxic"] }
    ]}
  },
  firered: {
    gyms: [
      ...
      { num: 2, leader: "Misty", city: "Cerulean City", badge: "Cascade Badge", team: [
        ...
        { name: "starmie", level: 21, ability: "Illuminate", moves: ["water-pulse", "rapid-spin", "recover", "swift"] }
      ]},
      { num: 3, leader: "Lt. Surge", city: "Vermilion City", badge: "Thunder Badge", team: [
        ...
        { name: "raichu", level: 24, ability: "Static", moves: ["quick-attack", "double-team", "shock-wave", "thunder-wave"] }
      ]},
      { num: 4, leader: "Erika", city: "Celadon City", badge: "Rainbow Badge", team: [
        ...
        { name: "vileplume", level: 29, ability: "Chlorophyll", moves: ["sleep-powder", "acid", "stun-spore", "giga-drain"] }
      ]},
      { num: 5, leader: "Koga", city: "Fuchsia City", badge: "Soul Badge", team: [
        ...
        { name: "koffing", level: 37, ability: "Levitate", moves: ["sludge", "smokescreen", "toxic", "selfdestruct"] }, 
        { name: "weezing", level: 43, ability: "Levitate", moves: ["tackle", "sludge", "toxic", "explosion"] }
      ]},
      { num: 6, leader: "Sabrina", city: "Saffron City", badge: "Marsh Badge", team: [
        ...
        { name: "alakazam", level: 43, ability: "Synchronize", moves: ["psychic", "recover", "future-sight", "calm-mind"] }
      ]},
      { num: 7, leader: "Blaine", city: "Cinnabar Island", badge: "Volcano Badge", team: [
        ...
        { name: "arcanine", level: 47, ability: "Intimidate", moves: ["bite", "roar", "take-down", "fire-blast"] }
      ]},
      { num: 8, leader: "Giovanni", city: "Viridian City", badge: "Earth Badge", team: [
        ...
        { name: "rhydon", level: 50, ability: "Lightning Rod", moves: ["rock-blast", "scary-face", "take-down", "earthquake"] }
      ]}
    ],
    elite: [
      { leader: "Lorelei", title: "Elite Four", team: [
        ...
        { name: "lapras", level: 54, ability: "Water Absorb", moves: ["body-slam", "confuse-ray", "surf", "ice-beam"] }
      ]},
      { leader: "Bruno", title: "Elite Four", team: [
        ...
        { name: "machamp", level: 58, ability: "Guts", moves: ["cross-chop", "rock-tomb", "scary-face", "bulk-up"] }
      ]},
      { leader: "Agatha", title: "Elite Four", team: [
        ...
        { name: "gengar", level: 60, ability: "Levitate", moves: ["shadow-ball", "sludge-bomb", "nightmare", "hypnosis"] }
      ]},
      { leader: "Lance", title: "Elite Four", team: [
        ...
        { name: "dragonite", level: 62, ability: "Inner Focus", moves: ["outrage", "wing-attack", "safeguard", "hyper-beam"] }
      ]}
    ],
    champion: { leader: "Blue", title: "Champion", team: [
      ...
      { name: "charizard", level: 65, ability: "Blaze", moves: ["fire-blast", "aerial-ace", "slash", "fire-spin"] }
    ]}
  },
  crystal: {
    gyms: [
      ...
      { num: 3, leader: "Whitney", city: "Goldenrod City", badge: "Plain Badge", team: [
        ...
        { name: "miltank", level: 20, ability: "Thick Fat", moves: ["stomp", "attract", "milk-drink", "rollout"] }
      ]},
      ...
      { num: 8, leader: "Clair", city: "Blackthorn City", badge: "Rising Badge", team: [
        ...
        { name: "kingdra", level: 40, ability: "Swift Swim", moves: ["smokescreen", "surf", "hyper-beam", "dragon-breath"] }
      ]}
    ],
    elite: [
    ...
    champion: { leader: "Lance", title: "Champion", team: [
      ...
      { name: "dragonite", level: 50, ability: "Inner Focus", moves: ["fire-blast", "safeguard", "outrage", "hyper-beam"] }
    ]},
    secret: { leader: "Red", title: "Pokemon Trainer", team: [
      { name: "pikachu", level: 81, ability: "Static", moves: ["charm", "quick-attack", "thunderbolt", "thunder"] }, 
      { name: "espeon", level: 73, ability: "Synchronize", moves: ["mud-slap", "reflect", "swift", "psychic"] }, 
      { name: "snorlax", level: 75, ability: "Thick Fat", moves: ["amnesia", "snore", "rest", "body-slam"] }, 
